...
<div className="bg-white p-6 md:p-8 rounded-2xl shadow-xl border border-gray-100">
    <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
        <div>
            ...
            <p className="text-sm text-gray-500 mt-1">سيتم التعامل مع رسالتك بسرية تامة</p>
        </div>
    ...
    <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-right">
        <div>
            <h4 className="font-bold text-emerald-900 text-base mb-1 flex items-center gap-2">
                <span>💬</span>
                <span>التواصل المباشر عبر واتساب</span>
            </h4>
            <p className="text-sm text-emerald-800 leading-relaxed">
                يمكنك تعبئة النموذج أدناه أو مراسلتنا مباشرة عبر خط الشكاوى المخصص للبلدية: 
                <span dir="ltr" className="font-bold mr-1 inline-block">81 886 539</span>
            </p>
        </div>
        <a 
            href="https://wa.me/96181886539?text=%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85%20%D8%B9%D9%84%D9%8A%D9%83%D9%85%D8%8C%20%D8%A3%D9%88%D8%AF%20%D8%AA%D9%82%D8%AF%D9%8A%D9%85%20%D8%B4%D9%83%D9%88%D9%89%20%D8%A3%D9%88%20%D8%A7%D9%82%D8%AA%D8%B1%D8%A7%D8%AD" 
            target="_blank" 
            rel="noopener noreferrer"
            className="bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold py-2.5 px-5 rounded-lg flex items-center justify-center gap-2 whitespace-nowrap shadow-md transition-all active:scale-95 text-sm w-full sm:w-auto"
        >
    ...
    <form onSubmit={handleComplaintSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label className="block text-gray-700 font-semibold mb-1">الاسم الكامل</label>
                <input 
                    type="text" 
        ...
        <div>
            <label className="block text-gray-700 font-semibold mb-1">الموضوع</label>
            <input 
                type="text" 
        ...
        <div>
            <label className="block text-gray-700 font-semibold mb-1">التفاصيل</label>
            <textarea 
        ...
        {status && (
            <p className={`text-sm font-bold text-center p-3 rounded-lg ${isError ? 'bg-red-50 text-red-600' : 'bg-green-50 text-green-700'}`}>
                {status}
            </p>
        )}
...
const FAQPage = () => {
    ...
    const faqs = [
        ...
        {
            question: " هل يجوز للمواطن تقسيط رسوم البلدية السنوية؟ ",
            answer: " 	يمكن في حالات خاصة يعود تقديرها لرئيس السلطة التنفيذية في البلدية، تقسيط المبالغ المفروضة وفقا للاصول على ان تتخذ التدابير القانونية التي تحول دون شمولها، كليا أو جزئيا، بعامل مرور الزمن. تصبح المبالغ المقسطة متوجبة الاداء بكاملها في الحالات الآتية: 1 - إذا تأخرالمكلف عن تأدية أحد الاقساط في موعد استحقاقه. 2 - عند بيع اموال المكلف بيعا جبريا او اختياريا. 3 - عند افلاس المكلف أو تصفية امواله تصفية قضائية. ... "
        },
        {
            question: "  ما هي الغرامة المترتبة على الرسوم البلدية؟ وكيف يتم احتسابها ؟ ",
            answer: "ان غرامة التأخير تتوجب بمجرد ّ تأخّر المكلّف عن سداد ما يتوجب عليه في خلال مهلة الشهرين القانونية من تاريخ الإعلان في الجريدة الرسمية سندا ( الى نص ّ المادة ۱٠٩من القانون رقم ٦٠/٨٨ قانون الرسوم والعلاوات البلدية وتعديلاته). تُحتَسب على الشكل الآتي:  يترتب على التأخير في تأدية الرسوم البلدية غرامة قدرها ۲% عن كل شهر تأخير، على أن يعتبر كسر الشهر شهرًا كاملا"
        },

         {
            question: "هل هناك من قانون يجازي من لم يصرّح عن اشغاله للمسكن؟",
            answer: "على مالك العقار أن يُعلم البلدية باشغال العقار، وإلّا تعرّض للغرامة المنصوص عليها في المادة ۱٤ من القانون رقم٦٠/٨٨–(قانون الرسوم والعلاوات البلدية وتعديلاته)"
        },

        {
            question: "كيف تكلّف الإعلانات؟",
    ...
    const contacts = [
        ...
        },
        {
            ...
            items: [
                ...
                { name: "مكتب الشكاوى والمراجعات", phone: "81 886 539", subtitle: "للشكاوى والمراجعات والتبليغات" },
            ]
        },
        {
            ...
            icon: "⚡",
            items: [
                { name: "مشتكي المولدات المحلية", phone: "70 883 590", subtitle: "استفسارات وأعطال اشتراك الكهرباء" },
